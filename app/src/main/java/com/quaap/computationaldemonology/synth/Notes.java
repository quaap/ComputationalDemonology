...
public class Notes {
    ...
    public static final float Cs2=69.30f;
    public static final float Db2=69.30f;
    ...
    public static final float Fs2=92.50f;
    public static final float Gb2=92.50f;
    public static final float G2=98.00f;
    public static final float Gs2=103.83f;
    public static final float Ab2=103.83f;
    public static final float A2=110.00f;
    ...
    public static final float Fs3=185.00f;
    public static final float Gb3=185.00f;
    public static final float G3=196.00f;
    public static final float Gs3=207.65f;
    public static final float Ab3=207.65f;
    public static final float A3=220.00f;
    ...
    public static final float G4=392.00f;
    public static final float Gs4=415.30f;
    public static final float Ab4=415.30f;
    public static final float A4=440.00f;
    ...
    public static final float A7=3520.00f;
    ...
    public static final float A8=7040.00f;
    ...
    static {
        for (int n=0; n<NOTES.length; n++) {
            NOTES[n] = (float)(Math.pow(2, (n+1-49)/12.0) * 440) ;
        }
    }
